<?php
/**
 * Connected website model (multi-client store registry).
 *
...
class CC_Website {
	...
	/**
	 * Register / connect a store. Returns the row (with api_key) on success.
	 *
	 * @param array $data {store_name, store_url, callback_url}.
	...
	public static function connect( array $data ) {
		...
		// Re-use existing record for the same URL.
