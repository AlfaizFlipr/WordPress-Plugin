...
<style>
	...
	.ns-hero {
		background: linear-gradient(160deg, #0A2540 0%, #13346e 60%, #1A56DB 100%);
		color: #fff;
		border-radius: 20px;
		overflow: hidden;
		position: relative;
	...
	<div class="ns-wrap">
		...
		<div class="ns-hero">
			<div class="ns-hero-in">
				...
				<p>Naya Setu Courier auto-syncs your orders, creates Delhivery shipments in one click, generates AWB
					numbers, and tracks every delivery — from one dashboard.</p>
				<div class="ns-cta">
		...
		<div class="ns-features">
			<div class="ns-feature">
				...
				<p>New orders flow into your dashboard the moment a customer checks out.</p>
			</div>
			<div class="ns-feature">
				<div class="ns-ic">📦</div>
				<h3>One-Click Shipments</h3>
				<p>Push any order to Delhivery and instantly generate an AWB. Bulk-book too.</p>
			</div>
			<div class="ns-feature">
				<div class="ns-ic">📍</div>
				<h3>Real-Time Tracking</h3>
				<p>Status syncs back to your store and dashboard automatically.</p>
			</div>
			<div class="ns-feature">
				<div class="ns-ic">🖨️</div>
				<h3>Bulk Label Printing</h3>
				<p>Download Delhivery labels and packing slips in one click.</p>
			</div>
			<div class="ns-feature">
				<div class="ns-ic">🏬</div>
				<h3>Multi-Store</h3>
				<p>Connect unlimited WooCommerce stores, manage from one place.</p>
			</div>
			<div class="ns-feature">
				<div class="ns-ic">📊</div>
				<h3>Live Stats</h3>
				<p>Total, Pending, Booked, In-Transit, Delivered — at a glance.</p>
			</div>
		</div>
		...
		<div class="ns-steps">
			<div class="ns-step">
				...
				<p>Upload the connector to your store.</p>
			</div>
			<div class="ns-step">
				<div class="ns-num"></div>
				<h4>Connect Store</h4>
				<p>Enter your dashboard URL and connect.</p>
			</div>
			<div class="ns-step">
				<div class="ns-num"></div>
				<h4>Sync Orders</h4>
				<p>Orders import automatically.</p>
			</div>
			<div class="ns-step">
				<div class="ns-num"></div>
				<h4>Ship &amp; Track</h4>
				<p>Push to Delhivery, print, track.</p>
			</div>
		</div>
