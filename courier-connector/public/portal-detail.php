...
<div class="ns-portal">
	<div class="ns-portal-bar">
		<div class="ns-portal-brand">
			...
			<div><strong>Naya Setu Courier</strong><small>Order #<?php echo esc_html( $wc->get_order_number() ); ?></small></div>
		</div>
		...
		<div class="cc-topbar">
			...
			<div>
				...
				<?php else : ?>
					...
					<button class="cc-btn cc-btn-danger cc-cancel" data-order="<?php echo esc_attr( $order->id() ); ?>">Cancel</button>
				<?php endif; ?>
			</div>
		</div>
